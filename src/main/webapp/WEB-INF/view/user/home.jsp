...
<div class="container" style="margin-top:30px;margin-bottom:50px">
	<div class="row">
		...
		<div class="col-md-9" id="content" 
		   style="border:solid;min-height:500px;background-color:#FFFAF0;overflow-x:scroll;overflow-y:scroll">
...
<nav class="navbar navbar-default navbar-fixed-bottom" style="background:#F0F8FF">
