	...
	<div class="modal-dialog" style="width:1000px;height:1000px" >
		<div class="modal-content">
			...
			<div class="modal-footer">
				<input type="button" class="btn btn-success" data-dismiss="modal" value="关闭">
...
<table class="table">
  ...
  <tbody>
    <c:forEach items="${pageInfo.list}" var="article">
	    <tr class="active">
	       <td style="background-color: #F0F8FF">${article.id}</td>
	       <td style="background-color: #F0F8FF">${article.title}</td>
	       <td style="background-color: #F0F8FF">${article.channel.name}</td>
	       <td style="background-color: #F0F8FF">${article.category.name}</td>
	       <td style="background-color: #F0F8FF">${article.user.username}</td>
	       <td style="background-color: #F0F8FF"><fmt:formatDate value="${article.created}" pattern="yyyy-MM-dd"/></td>
