		...
		<div class="row">
				...
				<div id="myCarousel" class="carousel slide" style="minheight:200px">
						...
						<div class="carousel-inner thumbnail" style="border-radius:12px;">
							<div class="item active">
								<img  class="img-rounded" src="/resource/images/912.jpg" style=" border-radius:23px; align:center;width:800px; height:400px;" alt="First slide">
							</div>
							<div  class="item">
								<img  class="img-rounded" src="/resource/images/913.jpg"  style="border-radius:23px; align:center;width:800px; height:400px;" alt="Second slide">
							</div>
							<div class="item">
								<img  class="img-rounded" src="/resource/images/911.jpg" style="border-radius:23px; align:center;width:800px; height:400px;" alt="Third slide">
							</div>
						</div>
						<!-- 轮播（Carousel）导航 -->
			...
			<div class="col-md-2" style=" margin-top:30px ;minheight:200px" >
				...
				<div class="panel panel-primary">
					...
					<div class="panel-body">
						<a href="http://www.4399.com/">1.大数据发展趋势</a>
						<br/>
						<a href="http://www.7k7k.com/">2.人工智能发展趋势</a>
					</div>
				</div>
